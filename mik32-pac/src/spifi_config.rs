...
impl RegisterBlock {
    ...
    #[doc = "0x14 - SPIFI регистр данных 32 бита. Если выходной буфер чтения пуст или входной буфер записи полон, то при отправке запроса по шине AHB будет вызвано исключение (код 5 \"Load access fault\")"]
    #[inline(always)]
    pub const fn data32(&self) -> &Data32 {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(20).cast() }
    }
    #[doc = "0x14 - SPIFI регистр данных 16 бит. Если выходной буфер чтения пуст или входной буфер записи полон, то при отправке запроса по шине AHB будет вызвано исключение (код 5 \"Load access fault\")"]
    #[inline(always)]
    pub const fn data16(&self) -> &Data16 {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(20).cast() }
    }
    #[doc = "0x14 - SPIFI регистр данных 8 бит. Если выходной буфер чтения пуст или входной буфер записи полон, то при отправке запроса по шине AHB будет вызвано исключение (код 5 \"Load access fault\")"]
    #[inline(always)]
