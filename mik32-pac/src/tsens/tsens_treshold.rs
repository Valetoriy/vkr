...
#[doc = "Field `TRESHOLD_HI` reader - При значении выхода сенсора больше HI_THRESHOLD будет формироваться прерывание. Значение по умолчанию соответствует температуре +125 *С"]
pub type TresholdHiR = crate::FieldReader<u16>;
#[doc = "Field `TRESHOLD_HI` writer - При значении выхода сенсора больше HI_THRESHOLD будет формироваться прерывание. Значение по умолчанию соответствует температуре +125 *С"]
pub type TresholdHiW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
#[doc = "Field `TRESHOLD_LOW` reader - При значении выхода сенсора менее LOW_THRESHOLD будет формироваться прерывание. Значение по умолчанию соответствует температуре -40 *C"]
pub type TresholdLowR = crate::FieldReader<u16>;
#[doc = "Field `TRESHOLD_LOW` writer - При значении выхода сенсора менее LOW_THRESHOLD будет формироваться прерывание. Значение по умолчанию соответствует температуре -40 *C"]
pub type TresholdLowW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    #[doc = "Bits 0:9 - При значении выхода сенсора больше HI_THRESHOLD будет формироваться прерывание. Значение по умолчанию соответствует температуре +125 *С"]
    #[inline(always)]
    pub fn treshold_hi(&self) -> TresholdHiR {
        TresholdHiR::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 10:19 - При значении выхода сенсора менее LOW_THRESHOLD будет формироваться прерывание. Значение по умолчанию соответствует температуре -40 *C"]
    #[inline(always)]
