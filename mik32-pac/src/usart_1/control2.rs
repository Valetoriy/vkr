...
#[doc = "Управление последним тактовым импульсом. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Lbcl {
...
#[doc = "Field `LBCL` reader - Управление последним тактовым импульсом. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `LBCL` writer - Управление последним тактовым импульсом. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление фазой выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cpha {
    #[doc = "0: Первое изменение тактового сигнала – фронт"]
    _0 = 0,
    #[doc = "1: Первое изменение тактового сигнала – спад (обратный фронт)"]
    _1 = 1,
}
...
#[doc = "Field `CPHA` reader - Управление фазой выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
impl CphaR {
    ...
    #[doc = "Первое изменение тактового сигнала – спад (обратный фронт)"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Cpha::_1
    }
}
#[doc = "Field `CPHA` writer - Управление фазой выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление полярностью выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cpol {
...
#[doc = "Field `CPOL` reader - Управление полярностью выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `CPOL` writer - Управление полярностью выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление синхронным режимом. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Clken {
    #[doc = "0: Синхронный режим выключен"]
    Asynchronous = 0,
    #[doc = "1: Синхронный режим включён"]
    Synchronous = 1,
}
...
#[doc = "Field `CLKEN` reader - Управление синхронным режимом. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
impl ClkenR {
    ...
    #[doc = "Синхронный режим включён"]
    #[inline(always)]
    pub fn is_synchronous(&self) -> bool {
        *self == Clken::Synchronous
    }
}
#[doc = "Field `CLKEN` writer - Управление синхронным режимом. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Количество стоп битов для приёмника и передатчика. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Stop1 {
    #[doc = "0: 1 стоп бит"]
    _1bit = 0,
...
#[doc = "Field `STOP_1` reader - Количество стоп битов для приёмника и передатчика. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `STOP_1` writer - Количество стоп битов для приёмника и передатчика. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Регистр режима обратной внутренней петли. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Lbm {
...
#[doc = "Field `LBM` reader - Регистр режима обратной внутренней петли. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `LBM` writer - Регистр режима обратной внутренней петли. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Обмен функциями TX выхода и RX входа. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Swap {
    #[doc = "0: Обычное функционирование"]
    Normal = 0,
...
#[doc = "Field `SWAP` reader - Обмен функциями TX выхода и RX входа. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `SWAP` writer - Обмен функциями TX выхода и RX входа. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление полярностью RX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rxinv {
...
#[doc = "Field `RXINV` reader - Управление полярностью RX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `RXINV` writer - Управление полярностью RX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление полярностью TX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Txinv {
    #[doc = "0: Обычная полярность. 0 - низкий уровень, 1 - высокий уровень"]
    Direct = 0,
...
#[doc = "Field `TXINV` reader - Управление полярностью TX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `TXINV` writer - Управление полярностью TX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление полярностью принимаемых и передаваемых данных. Изменение полярности не влияет на бит чётности. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Datainv {
    #[doc = "0: Обычная полярность. 0 - низкий уровень, 1 - высокий уровень"]
    Direct = 0,
...
#[doc = "Field `DATAINV` reader - Управление полярностью принимаемых и передаваемых данных. Изменение полярности не влияет на бит чётности. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `DATAINV` writer - Управление полярностью принимаемых и передаваемых данных. Изменение полярности не влияет на бит чётности. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление очередностью приёма и передачи данных. Этот бит не влияет на передачу и приём бита чётности. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Msbfirst {
...
#[doc = "Field `MSBFIRST` reader - Управление очередностью приёма и передачи данных. Этот бит не влияет на передачу и приём бита чётности. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `MSBFIRST` writer - Управление очередностью приёма и передачи данных. Этот бит не влияет на передачу и приём бита чётности. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
impl R {
    ...
    #[doc = "Bit 8 - Управление последним тактовым импульсом. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn lbcl(&self) -> LbclR {
        LbclR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Управление фазой выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn cpha(&self) -> CphaR {
        CphaR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Управление полярностью выходного тактового сигнала CK. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn cpol(&self) -> CpolR {
        CpolR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Управление синхронным режимом. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn clken(&self) -> ClkenR {
        ClkenR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 13 - Количество стоп битов для приёмника и передатчика. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn stop_1(&self) -> Stop1R {
        Stop1R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Регистр режима обратной внутренней петли. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn lbm(&self) -> LbmR {
        LbmR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Обмен функциями TX выхода и RX входа. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn swap(&self) -> SwapR {
        SwapR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - Управление полярностью RX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn rxinv(&self) -> RxinvR {
        RxinvR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Управление полярностью TX выхода. Регистр влияет не только на данные, но и на стоп биты, старт биты и т.д. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn txinv(&self) -> TxinvR {
        TxinvR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - Управление полярностью принимаемых и передаваемых данных. Изменение полярности не влияет на бит чётности. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn datainv(&self) -> DatainvR {
        DatainvR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - Управление очередностью приёма и передачи данных. Этот бит не влияет на передачу и приём бита чётности. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
