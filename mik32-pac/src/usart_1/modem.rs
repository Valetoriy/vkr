...
#[doc = "Флаг взводится при изменении входного сигнала DSR. Флаг сбрасывается записью 1\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dsrif {
    #[doc = "0: Изменений сигнала не обнаружено с момента сброса флага"]
    _0 = 0,
    #[doc = "1: Сигнал изменён с момента сброса флага"]
    _1 = 1,
}
...
#[doc = "Field `DSRIF` reader - Флаг взводится при изменении входного сигнала DSR. Флаг сбрасывается записью 1"]
...
impl DsrifR {
    ...
    #[doc = "Сигнал изменён с момента сброса флага"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Dsrif::_1
    }
}
#[doc = "Field `DSRIF` writer - Флаг взводится при изменении входного сигнала DSR. Флаг сбрасывается записью 1"]
...
#[doc = "Флаг взводится при изменении входного сигнала RI с 0 на 1. Флаг сбрасывается записью 1\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Riif {
...
#[doc = "Field `RIIF` reader - Флаг взводится при изменении входного сигнала RI с 0 на 1. Флаг сбрасывается записью 1"]
...
#[doc = "Field `RIIF` writer - Флаг взводится при изменении входного сигнала RI с 0 на 1. Флаг сбрасывается записью 1"]
...
pub enum Ri {
    ...
    _0 = 0,
    #[doc = "1: Звонок (вызов) на телефонной линии"]
    _1 = 1,
}
...
impl RiR {
    ...
    #[doc = "Звонок (вызов) на телефонной линии"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Ri::_1
    }
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dtr {
    #[doc = "0: Отсутствие сигнала готовности"]
    Unready = 0,
    #[doc = "1: Готовность к приёму данных"]
    Ready = 1,
}
...
impl DtrR {
    ...
    #[doc = "Отсутствие сигнала готовности"]
    #[inline(always)]
    pub fn is_unready(&self) -> bool {
        *self == Dtr::Unready
    }
    #[doc = "Готовность к приёму данных"]
    #[inline(always)]
    pub fn is_ready(&self) -> bool {
        *self == Dtr::Ready
    }
...
impl R {
    #[doc = "Bit 1 - Флаг взводится при изменении входного сигнала DSR. Флаг сбрасывается записью 1"]
    #[inline(always)]
    pub fn dsrif(&self) -> DsrifR {
        DsrifR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Флаг взводится при изменении входного сигнала RI с 0 на 1. Флаг сбрасывается записью 1"]
    #[inline(always)]
