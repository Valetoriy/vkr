...
#[doc = "Field `OUT_UNDER_FLAG` reader - Текущее состояние линии монитора нижнего порога с учётом цифровой фильтрации"]
pub type OutUnderFlagR = crate::BitReader;
#[doc = "Field `OUT_OVER_FLAG` reader - Текущее состояние линии монитора верхнего порога с учётом цифровой фильтрации"]
...
impl R {
    ...
    #[doc = "Bit 2 - Текущее состояние линии монитора нижнего порога с учётом цифровой фильтрации"]
    #[inline(always)]
    pub fn out_under_flag(&self) -> OutUnderFlagR {
        OutUnderFlagR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Текущее состояние линии монитора верхнего порога с учётом цифровой фильтрации"]
    #[inline(always)]
