...
#[doc = "Field `EN_VREFCLB` reader - Использование в качестве источника опорного напряжения калибруемый ИОН"]
pub type EnVrefclbR = crate::BitReader;
#[doc = "Field `EN_VREFCLB` writer - Использование в качестве источника опорного напряжения калибруемый ИОН"]
...
impl R {
    ...
    #[doc = "Bit 12 - Использование в качестве источника опорного напряжения калибруемый ИОН"]
    #[inline(always)]
