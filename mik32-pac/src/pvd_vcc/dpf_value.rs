...
pub type DpfW<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
impl R {
    #[doc = "Bits 0:14 - Коэффициент, определяющий длительность отфильтровываемых импульсов (на системной частоте)"]
    #[inline(always)]
    pub fn dpf(&self) -> DpfR {
        DpfR::new((self.bits & 0x7fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:14 - Коэффициент, определяющий длительность отфильтровываемых импульсов (на системной частоте)"]
