...
pub enum Source {
    ...
    Tim1 = 1,
    #[doc = "2: вход TIMER32_1_Tx микросхемы"]
    Timer32_1Tx = 2,
...
impl SourceR {
    ...
    #[doc = "вход TIMER32_1_Tx микросхемы"]
    #[inline(always)]
    pub fn is_timer32_1_tx(&self) -> bool {
        *self == Source::Timer32_1Tx
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "вход TIMER32_1_Tx микросхемы"]
    #[inline(always)]
    pub fn timer32_1_tx(self) -> &'a mut crate::W<REG> {
        self.variant(Source::Timer32_1Tx)
    }
    #[doc = "асинхронный вход тактирования TIM2"]
    #[inline(always)]
