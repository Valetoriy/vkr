...
pub type R = crate::R<Ch3CntrlSpec>;
#[doc = "Register `CH3_CNTRL` writer"]
pub type W = crate::W<Ch3CntrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Управление фильтрацией входных помех на входе ic_port: 0 – фильтрация выключена; 1 – фильтрация выключена"]
    #[inline(always)]
    pub fn noise(&mut self) -> NoiseW<Ch3CntrlSpec> {
        NoiseW::new(self, 0)
    }
    #[doc = "Bit 4 - Режим сигнала захвата"]
    #[inline(always)]
    pub fn edge(&mut self) -> EdgeW<Ch3CntrlSpec> {
        EdgeW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Режим работы канала"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Ch3CntrlSpec> {
        ModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Включение/выключение канала"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Ch3CntrlSpec> {
        EnW::new(self, 7)
    }
    #[doc = "Bit 8 - Тип вывода в режиме ШИМ инвертирование"]
    #[inline(always)]
    pub fn pwm_inv(&mut self) -> PwmInvW<Ch3CntrlSpec> {
        PwmInvW::new(self, 8)
    }
}
#[doc = "Конфигурационный регистр 3 канала\n\nYou can [`read`](crate::Reg::read) this register and get [`ch3_cntrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch3_cntrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch3CntrlSpec;
impl crate::RegisterSpec for Ch3CntrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch3_cntrl::R`](R) reader structure"]
impl crate::Readable for Ch3CntrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch3_cntrl::W`](W) writer structure"]
impl crate::Writable for Ch3CntrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH3_CNTRL to value 0"]
impl crate::Resettable for Ch3CntrlSpec {}
