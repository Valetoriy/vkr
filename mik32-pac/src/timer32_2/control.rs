...
#[repr(u8)]
pub enum Source {
    #[doc = "0: частота тактов шины APB_P"]
    ApbPClk = 0,
    #[doc = "1: синхронный вход тактирования TIM1"]
    Tim1 = 1,
    #[doc = "2: вход TIMER32_2_Tx микросхемы"]
    Timer32_2Tx = 2,
...
impl SourceR {
    ...
    pub const fn variant(&self) -> Source {
        match self.bits {
            0 => Source::ApbPClk,
            1 => Source::Tim1,
            2 => Source::Timer32_2Tx,
            3 => Source::Tim2,
            _ => unreachable!(),
        }
    }
    #[doc = "частота тактов шины APB_P"]
    #[inline(always)]
    ...
    #[doc = "вход TIMER32_2_Tx микросхемы"]
    #[inline(always)]
    pub fn is_timer32_2_tx(&self) -> bool {
        *self == Source::Timer32_2Tx
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "вход TIMER32_2_Tx микросхемы"]
    #[inline(always)]
    pub fn timer32_2_tx(self) -> &'a mut crate::W<REG> {
        self.variant(Source::Timer32_2Tx)
    }
    #[doc = "асинхронный вход тактирования TIM2"]
    #[inline(always)]
