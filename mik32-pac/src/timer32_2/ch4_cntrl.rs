...
pub type R = crate::R<Ch4CntrlSpec>;
#[doc = "Register `CH4_CNTRL` writer"]
pub type W = crate::W<Ch4CntrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Управление фильтрацией входных помех на входе ic_port: 0 – фильтрация выключена; 1 – фильтрация выключена"]
    #[inline(always)]
    pub fn noise(&mut self) -> NoiseW<Ch4CntrlSpec> {
        NoiseW::new(self, 0)
    }
    #[doc = "Bit 4 - Режим сигнала захвата"]
    #[inline(always)]
    pub fn edge(&mut self) -> EdgeW<Ch4CntrlSpec> {
        EdgeW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Режим работы канала"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Ch4CntrlSpec> {
        ModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Включение/выключение канала"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Ch4CntrlSpec> {
        EnW::new(self, 7)
    }
    #[doc = "Bit 8 - Тип вывода в режиме ШИМ инвертирование"]
    #[inline(always)]
    pub fn pwm_inv(&mut self) -> PwmInvW<Ch4CntrlSpec> {
        PwmInvW::new(self, 8)
    }
}
#[doc = "Конфигурационный регистр 4 канала\n\nYou can [`read`](crate::Reg::read) this register and get [`ch4_cntrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch4_cntrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch4CntrlSpec;
impl crate::RegisterSpec for Ch4CntrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch4_cntrl::R`](R) reader structure"]
impl crate::Readable for Ch4CntrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch4_cntrl::W`](W) writer structure"]
impl crate::Writable for Ch4CntrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH4_CNTRL to value 0"]
impl crate::Resettable for Ch4CntrlSpec {}
