...
#[doc = "Field `TIM_PRESCALE` reader - Значение предварительного делителя. Предделитель вырабатывает тактовый сигнал для счёта, частота которого в целое число раз меньше входной"]
pub type TimPrescaleR = crate::FieldReader<u32>;
#[doc = "Field `TIM_PRESCALE` writer - Значение предварительного делителя. Предделитель вырабатывает тактовый сигнал для счёта, частота которого в целое число раз меньше входной"]
pub type TimPrescaleW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Значение предварительного делителя. Предделитель вырабатывает тактовый сигнал для счёта, частота которого в целое число раз меньше входной"]
    #[inline(always)]
