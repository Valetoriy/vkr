...
#[doc = "Селектор тактовых импульсов. Бит CKSEL выбирает, какой источник тактовых импульсов будет использовать TIMER16\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cksel {
    #[doc = "0: TIMER16 тактируется внутренним источником тактового сигнала (APB тактовый генератор или любой из внутренних генераторов)"]
    Internal = 0,
    #[doc = "1: TIMER16 тактируется внешним источником тактового сигнала через внешний Input1 TIMER16"]
    External = 1,
}
...
#[doc = "Field `CKSEL` reader - Селектор тактовых импульсов. Бит CKSEL выбирает, какой источник тактовых импульсов будет использовать TIMER16"]
...
impl CkselR {
    ...
    #[doc = "TIMER16 тактируется внутренним источником тактового сигнала (APB тактовый генератор или любой из внутренних генераторов)"]
    #[inline(always)]
    pub fn is_internal(&self) -> bool {
        *self == Cksel::Internal
    }
    #[doc = "TIMER16 тактируется внешним источником тактового сигнала через внешний Input1 TIMER16"]
    #[inline(always)]
    pub fn is_external(&self) -> bool {
        *self == Cksel::External
    }
}
#[doc = "Field `CKSEL` writer - Селектор тактовых импульсов. Бит CKSEL выбирает, какой источник тактовых импульсов будет использовать TIMER16"]
...
#[doc = "Полярность синхронизации. Когда TIMER16 тактируется внешним источником тактового сигнала, биты CKPOL используются для настройки активного фронта или фронтов, используемых счётчиком\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Ckpol {
    #[doc = "0: Нарастающий фронт является активным фронтом, используемым для подсчёта"]
    Rising = 0,
    #[doc = "1: Спадающий фронт является активным фронтом, используемым для подсчёта"]
    Falling = 1,
...
#[doc = "Field `CKPOL` reader - Полярность синхронизации. Когда TIMER16 тактируется внешним источником тактового сигнала, биты CKPOL используются для настройки активного фронта или фронтов, используемых счётчиком"]
...
impl CkpolR {
    ...
    pub const fn variant(&self) -> Option<Ckpol> {
        match self.bits {
            0 => Some(Ckpol::Rising),
            1 => Some(Ckpol::Falling),
            2 => Some(Ckpol::BothEdge),
            _ => None,
        }
    }
    #[doc = "Нарастающий фронт является активным фронтом, используемым для подсчёта"]
    #[inline(always)]
    pub fn is_rising(&self) -> bool {
        *self == Ckpol::Rising
    }
    #[doc = "Спадающий фронт является активным фронтом, используемым для подсчёта"]
    #[inline(always)]
...
#[doc = "Field `CKPOL` writer - Полярность синхронизации. Когда TIMER16 тактируется внешним источником тактового сигнала, биты CKPOL используются для настройки активного фронта или фронтов, используемых счётчиком"]
...
#[doc = "Делитель частоты. Биты PRESC задают коэффициент деления делителя\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Presc {
    #[doc = "0: Делитель = 1"]
...
#[doc = "Field `PRESC` reader - Делитель частоты. Биты PRESC задают коэффициент деления делителя"]
...
#[doc = "Field `PRESC` writer - Делитель частоты. Биты PRESC задают коэффициент деления делителя"]
...
#[doc = "Селектор триггера. Биты TRIGSEL выбирают источник триггера, который будет служить событием запуска для TIMER16, из 8-ми доступных источников\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Trigsel {
    ...
    Tsens = 4,
    #[doc = "5: Источник триггера - окончание преобразования АЦП"]
    Adc = 5,
    #[doc = "6: Источник триггера - прерывание RTC"]
    RtcIrq = 6,
    #[doc = "7: Источник триггера - будильник"]
    Alarm = 7,
}
...
#[doc = "Field `TRIGSEL` reader - Селектор триггера. Биты TRIGSEL выбирают источник триггера, который будет служить событием запуска для TIMER16, из 8-ми доступных источников"]
...
impl TrigselR {
    ...
    #[doc = "Источник триггера - окончание преобразования АЦП"]
    #[inline(always)]
    ...
    #[doc = "Источник триггера - будильник"]
    #[inline(always)]
    pub fn is_alarm(&self) -> bool {
        *self == Trigsel::Alarm
    }
}
#[doc = "Field `TRIGSEL` writer - Селектор триггера. Биты TRIGSEL выбирают источник триггера, который будет служить событием запуска для TIMER16, из 8-ми доступных источников"]
...
#[doc = "Разрешение и полярность триггера. Бит TRIGEN управляет тем, запускается ли счётчик TIMER16 внешним триггером или нет. Если выбрана опция внешнего запуска, возможны три конфигурации активного фронта триггера\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Trigen {
    #[doc = "0: Программный триггер (начало отсчёта инициируется программно)"]
    Software = 0,
    #[doc = "1: Нарастающий фронт является активным фронтом"]
    Rising = 1,
    #[doc = "2: Падающий фронт является активным фронтом"]
    Falling = 2,
    #[doc = "3: Оба фронта являются активными фронтами"]
    BothEdge = 3,
}
...
#[doc = "Field `TRIGEN` reader - Разрешение и полярность триггера. Бит TRIGEN управляет тем, запускается ли счётчик TIMER16 внешним триггером или нет. Если выбрана опция внешнего запуска, возможны три конфигурации активного фронта триггера"]
...
impl TrigenR {
    ...
    #[doc = "Программный триггер (начало отсчёта инициируется программно)"]
    #[inline(always)]
    ...
    #[doc = "Оба фронта являются активными фронтами"]
    #[inline(always)]
    pub fn is_both_edge(&self) -> bool {
        *self == Trigen::BothEdge
    }
}
#[doc = "Field `TRIGEN` writer - Разрешение и полярность триггера. Бит TRIGEN управляет тем, запускается ли счётчик TIMER16 внешним триггером или нет. Если выбрана опция внешнего запуска, возможны три конфигурации активного фронта триггера"]
...
pub enum Timeout {
    ...
    TriggerEventIgnor = 0,
    #[doc = "1: Триггерное событие, поступающее, когда таймер уже запущен, сбросит и перезапустит счётчик"]
...
impl TimeoutR {
    ...
    #[doc = "Триггерное событие, поступающее, когда таймер уже запущен, сбросит и перезапустит счётчик"]
    #[inline(always)]
...
#[doc = "Бит COUNTMODE выбирает, какой источник тактового сигнала используется TIMER16 для синхронизации счётчика\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CountMode {
    #[doc = "0: Счётчик инкрементируется после каждого внутреннего тактового импульса"]
    Internal = 0,
    #[doc = "1: Счётчик увеличивается после каждого действительного тактового импульса на внешнем Input1 TIMER16"]
    External = 1,
}
...
#[doc = "Field `COUNT_MODE` reader - Бит COUNTMODE выбирает, какой источник тактового сигнала используется TIMER16 для синхронизации счётчика"]
...
impl CountModeR {
    ...
    #[doc = "Счётчик инкрементируется после каждого внутреннего тактового импульса"]
    #[inline(always)]
    pub fn is_internal(&self) -> bool {
        *self == CountMode::Internal
    }
    #[doc = "Счётчик увеличивается после каждого действительного тактового импульса на внешнем Input1 TIMER16"]
    #[inline(always)]
    pub fn is_external(&self) -> bool {
        *self == CountMode::External
    }
}
#[doc = "Field `COUNT_MODE` writer - Бит COUNTMODE выбирает, какой источник тактового сигнала используется TIMER16 для синхронизации счётчика"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Enc {
    #[doc = "0: Режим энкодера отключён"]
    Disable = 0,
    #[doc = "1: Режим энкодера включён"]
    Enable = 1,
}
...
impl EncR {
    ...
    #[doc = "Режим энкодера отключён"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == Enc::Disable
    }
    #[doc = "Режим энкодера включён"]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Селектор тактовых импульсов. Бит CKSEL выбирает, какой источник тактовых импульсов будет использовать TIMER16"]
    #[inline(always)]
    pub fn cksel(&self) -> CkselR {
        CkselR::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:2 - Полярность синхронизации. Когда TIMER16 тактируется внешним источником тактового сигнала, биты CKPOL используются для настройки активного фронта или фронтов, используемых счётчиком"]
    #[inline(always)]
    ...
    #[doc = "Bits 9:11 - Делитель частоты. Биты PRESC задают коэффициент деления делителя"]
    #[inline(always)]
    pub fn presc(&self) -> PrescR {
        PrescR::new(((self.bits >> 9) & 7) as u8)
    }
    #[doc = "Bits 13:15 - Селектор триггера. Биты TRIGSEL выбирают источник триггера, который будет служить событием запуска для TIMER16, из 8-ми доступных источников"]
    #[inline(always)]
    pub fn trigsel(&self) -> TrigselR {
        TrigselR::new(((self.bits >> 13) & 7) as u8)
    }
    #[doc = "Bits 17:18 - Разрешение и полярность триггера. Бит TRIGEN управляет тем, запускается ли счётчик TIMER16 внешним триггером или нет. Если выбрана опция внешнего запуска, возможны три конфигурации активного фронта триггера"]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - Бит COUNTMODE выбирает, какой источник тактового сигнала используется TIMER16 для синхронизации счётчика"]
    #[inline(always)]
