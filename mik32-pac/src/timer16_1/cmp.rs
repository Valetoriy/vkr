...
#[doc = "Field `CMP` reader - Сравниваемое значение. CMP - это значение сравнения, используемое TIMER16. Примечание: Регистр CMP может быть изменён только тогда, когда TIMER16 включён (бит ENABLE установлен в «1»)"]
pub type CmpR = crate::FieldReader<u16>;
#[doc = "Field `CMP` writer - Сравниваемое значение. CMP - это значение сравнения, используемое TIMER16. Примечание: Регистр CMP может быть изменён только тогда, когда TIMER16 включён (бит ENABLE установлен в «1»)"]
pub type CmpW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Сравниваемое значение. CMP - это значение сравнения, используемое TIMER16. Примечание: Регистр CMP может быть изменён только тогда, когда TIMER16 включён (бит ENABLE установлен в «1»)"]
    #[inline(always)]
