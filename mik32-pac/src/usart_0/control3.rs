...
#[doc = "Управление прерыванием при обнаружении ошибок приёма данных (FE, ORE, NF)\n\nValue on reset: 0"]
...
#[doc = "Field `EIE` reader - Управление прерыванием при обнаружении ошибок приёма данных (FE, ORE, NF)"]
...
#[doc = "Field `EIE` writer - Управление прерыванием при обнаружении ошибок приёма данных (FE, ORE, NF)"]
...
#[doc = "Выбор между полудуплексным и дуплексным режимами работы. В полудуплексном режиме RX не используется, все данные передаются и принимаются через TX. При наличии данных на передачу происходит отправка данных в остальное время приём. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Hdsel {
...
#[doc = "Field `HDSEL` reader - Выбор между полудуплексным и дуплексным режимами работы. В полудуплексном режиме RX не используется, все данные передаются и принимаются через TX. При наличии данных на передачу происходит отправка данных в остальное время приём. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `HDSEL` writer - Выбор между полудуплексным и дуплексным режимами работы. В полудуплексном режиме RX не используется, все данные передаются и принимаются через TX. При наличии данных на передачу происходит отправка данных в остальное время приём. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление работой сигнала dma_rrq\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dmar {
    #[doc = "0: Сигнал выключен"]
    Disable = 0,
    #[doc = "1: Сигнал включён"]
    Enable = 1,
}
...
#[doc = "Field `DMAR` reader - Управление работой сигнала dma_rrq"]
...
#[doc = "Field `DMAR` writer - Управление работой сигнала dma_rrq"]
...
#[doc = "Управление выходным сигналом RTS. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rtse {
    #[doc = "0: Сигнал всегда в разрешающем состоянии (RTS = 0)"]
    _0 = 0,
    #[doc = "1: Сигнал находится в разрешающем состоянии (RTS = 0), только когда приёмник готов принять данные"]
    _1 = 1,
}
...
#[doc = "Field `RTSE` reader - Управление выходным сигналом RTS. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
impl RtseR {
    ...
    #[doc = "Сигнал находится в разрешающем состоянии (RTS = 0), только когда приёмник готов принять данные"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Rtse::_1
    }
}
#[doc = "Field `RTSE` writer - Управление выходным сигналом RTS. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Выбор реакции на входной сигнал CTS. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ctse {
...
#[doc = "Field `CTSE` reader - Выбор реакции на входной сигнал CTS. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `CTSE` writer - Выбор реакции на входной сигнал CTS. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Управление прерыванием при обнаружении изменения CTS\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ctsie {
    #[doc = "0: Прерывание выключено"]
    Disable = 0,
...
#[doc = "Field `CTSIE` reader - Управление прерыванием при обнаружении изменения CTS"]
...
#[doc = "Field `CTSIE` writer - Управление прерыванием при обнаружении изменения CTS"]
...
#[doc = "Выбор реакции на переполнение. Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ovrdis {
...
#[doc = "Field `OVRDIS` reader - Выбор реакции на переполнение. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `OVRDIS` writer - Выбор реакции на переполнение. Этот бит может быть изменён только при остановке работы (UE=0)"]
...
impl R {
    #[doc = "Bit 0 - Управление прерыванием при обнаружении ошибок приёма данных (FE, ORE, NF)"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Выбор между полудуплексным и дуплексным режимами работы. В полудуплексном режиме RX не используется, все данные передаются и принимаются через TX. При наличии данных на передачу происходит отправка данных в остальное время приём. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn hdsel(&self) -> HdselR {
        HdselR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 6 - Управление работой сигнала dma_rrq"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Управление выходным сигналом RTS. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn rtse(&self) -> RtseR {
        RtseR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Выбор реакции на входной сигнал CTS. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn ctse(&self) -> CtseR {
        CtseR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Управление прерыванием при обнаружении изменения CTS"]
    #[inline(always)]
    pub fn ctsie(&self) -> CtsieR {
        CtsieR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 12 - Выбор реакции на переполнение. Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
