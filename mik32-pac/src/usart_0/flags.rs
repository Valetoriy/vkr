...
#[doc = "Флаг обнаружения ошибочного бита чётности. Флаг сбрасывается записью «1»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Pe {
    #[doc = "0: Ошибок в битах чётности не обнаружено с момента сброса флага"]
    _0 = 0,
    #[doc = "1: Ошибка в бите чётности обнаружена с момента сброса флага"]
    _1 = 1,
}
...
#[doc = "Field `PE` reader - Флаг обнаружения ошибочного бита чётности. Флаг сбрасывается записью «1»"]
...
impl PeR {
    ...
    #[doc = "Ошибок в битах чётности не обнаружено с момента сброса флага"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Pe::_0
    }
    #[doc = "Ошибка в бите чётности обнаружена с момента сброса флага"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Pe::_1
    }
}
#[doc = "Field `PE` writer - Флаг обнаружения ошибочного бита чётности. Флаг сбрасывается записью «1»"]
...
#[doc = "Флаг взводится при обнаружении ошибок в стоп бите или битах. Флаг сбрасывается записью «1»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Fe {
    #[doc = "0: Ошибок приёма не обнаружено с момента сброса флага"]
    _0 = 0,
    #[doc = "1: Ошибка приёма обнаружена с момента сброса флага"]
    _1 = 1,
}
...
#[doc = "Field `FE` reader - Флаг взводится при обнаружении ошибок в стоп бите или битах. Флаг сбрасывается записью «1»"]
...
impl FeR {
    ...
    #[doc = "Ошибок приёма не обнаружено с момента сброса флага"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Fe::_0
    }
    #[doc = "Ошибка приёма обнаружена с момента сброса флага"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Fe::_1
    }
}
#[doc = "Field `FE` writer - Флаг взводится при обнаружении ошибок в стоп бите или битах. Флаг сбрасывается записью «1»"]
...
#[doc = "Флаг обнаружения ложных переключений на линии RX. Флаг сбрасывается записью «1»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Nf {
...
#[doc = "Field `NF` reader - Флаг обнаружения ложных переключений на линии RX. Флаг сбрасывается записью «1»"]
...
#[doc = "Field `NF` writer - Флаг обнаружения ложных переключений на линии RX. Флаг сбрасывается записью «1»"]
...
#[doc = "Флаг взводится при записи принятых данных в регистр RDR из сдвигового регистра. Флаг сбрасывается записью «1» или чтением регистра RDR\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rxne {
...
#[doc = "Field `RXNE` reader - Флаг взводится при записи принятых данных в регистр RDR из сдвигового регистра. Флаг сбрасывается записью «1» или чтением регистра RDR"]
...
#[doc = "Field `RXNE` writer - Флаг взводится при записи принятых данных в регистр RDR из сдвигового регистра. Флаг сбрасывается записью «1» или чтением регистра RDR"]
...
#[doc = "Флаг взводится при передаче данных в момент отправки последнего стоп бита. Флаг сбрасывается записью «1»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Tc {
...
#[doc = "Field `TC` reader - Флаг взводится при передаче данных в момент отправки последнего стоп бита. Флаг сбрасывается записью «1»"]
...
#[doc = "Field `TC` writer - Флаг взводится при передаче данных в момент отправки последнего стоп бита. Флаг сбрасывается записью «1»"]
...
#[doc = "Флаг взводится при изменении значения сигнала CTS. Флаг сбрасывается записью «1»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ctsif {
...
#[doc = "Field `CTSIF` reader - Флаг взводится при изменении значения сигнала CTS. Флаг сбрасывается записью «1»"]
...
#[doc = "Field `CTSIF` writer - Флаг взводится при изменении значения сигнала CTS. Флаг сбрасывается записью «1»"]
...
pub enum Busy {
    ...
    Inactive = 0,
    #[doc = "1: Идёт передача данных или break состояние"]
    Active = 1,
}
...
impl BusyR {
    ...
    #[doc = "Идёт передача данных или break состояние"]
    #[inline(always)]
...
#[doc = "Флаг готовности приёмника к работе после снятия сброса (UE и RE)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Reack {
...
#[doc = "Field `REACK` reader - Флаг готовности приёмника к работе после снятия сброса (UE и RE)"]
...
impl R {
    #[doc = "Bit 0 - Флаг обнаружения ошибочного бита чётности. Флаг сбрасывается записью «1»"]
    #[inline(always)]
    pub fn pe(&self) -> PeR {
        PeR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Флаг взводится при обнаружении ошибок в стоп бите или битах. Флаг сбрасывается записью «1»"]
    #[inline(always)]
    pub fn fe(&self) -> FeR {
        FeR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Флаг обнаружения ложных переключений на линии RX. Флаг сбрасывается записью «1»"]
    #[inline(always)]
    pub fn nf(&self) -> NfR {
    ...
    #[doc = "Bit 5 - Флаг взводится при записи принятых данных в регистр RDR из сдвигового регистра. Флаг сбрасывается записью «1» или чтением регистра RDR"]
    #[inline(always)]
    pub fn rxne(&self) -> RxneR {
        RxneR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Флаг взводится при передаче данных в момент отправки последнего стоп бита. Флаг сбрасывается записью «1»"]
    #[inline(always)]
    pub fn tc(&self) -> TcR {
    ...
    #[doc = "Bit 9 - Флаг взводится при изменении значения сигнала CTS. Флаг сбрасывается записью «1»"]
    #[inline(always)]
    ...
    #[doc = "Bit 22 - Флаг готовности приёмника к работе после снятия сброса (UE и RE)"]
    #[inline(always)]
