...
#[doc = "Управление приёмником\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Re {
    #[doc = "0: Приёмник выключен"]
    Disable = 0,
    #[doc = "1: Приёмник включён"]
    Enable = 1,
}
...
#[doc = "Field `RE` reader - Управление приёмником"]
...
impl ReR {
    ...
    #[doc = "Приёмник выключен"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == Re::Disable
    }
    #[doc = "Приёмник включён"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == Re::Enable
    }
}
#[doc = "Field `RE` writer - Управление приёмником"]
...
#[doc = "Управление прерыванием при успешном приёме данных или перезаписи полученных данных\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rxneie {
    #[doc = "0: Прерывание выключено"]
    Disable = 0,
...
#[doc = "Field `RXNEIE` reader - Управление прерыванием при успешном приёме данных или перезаписи полученных данных"]
...
#[doc = "Field `RXNEIE` writer - Управление прерыванием при успешном приёме данных или перезаписи полученных данных"]
...
#[doc = "Управление прерыванием при ошибке в принятом бите чётности\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Peie {
    #[doc = "0: Прерывание по ошибке в бите чётности выключено"]
    Disable = 0,
    #[doc = "1: Прерывание по ошибке в бите чётности включено"]
    Enable = 1,
}
...
#[doc = "Field `PEIE` reader - Управление прерыванием при ошибке в принятом бите чётности"]
...
impl PeieR {
    ...
    #[doc = "Прерывание по ошибке в бите чётности выключено"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == Peie::Disable
    }
    #[doc = "Прерывание по ошибке в бите чётности включено"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == Peie::Enable
    }
}
#[doc = "Field `PEIE` writer - Управление прерыванием при ошибке в принятом бите чётности"]
...
#[doc = "Выбор способа формирования бита чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ps {
    #[doc = "0: Бит чётности"]
    Parity = 0,
    #[doc = "1: Бит нечётности"]
    Odd = 1,
}
...
#[doc = "Field `PS` reader - Выбор способа формирования бита чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Field `PS` writer - Выбор способа формирования бита чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "Контроль чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Pce {
    #[doc = "0: Контроль чётности выключен"]
    Disable = 0,
    #[doc = "1: Контроль чётности включён"]
    Enable = 1,
}
...
#[doc = "Field `PCE` reader - Контроль чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)"]
...
impl PceR {
    ...
    #[doc = "Контроль чётности выключен"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == Pce::Disable
    }
    #[doc = "Контроль чётности включён"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == Pce::Enable
    }
}
#[doc = "Field `PCE` writer - Контроль чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)"]
...
#[doc = "M1\\[28\\] и M0\\[12\\] управляют длиной кадра. Примечание: Эти биты могут быть изменены только при остановке работы (UE=0)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u32)]
pub enum M {
    #[doc = "0: 8 бит данных"]
...
#[doc = "Field `M` reader - M1\\[28\\] и M0\\[12\\] управляют длиной кадра. Примечание: Эти биты могут быть изменены только при остановке работы (UE=0)"]
...
#[doc = "Field `M` writer - M1\\[28\\] и M0\\[12\\] управляют длиной кадра. Примечание: Эти биты могут быть изменены только при остановке работы (UE=0)"]
...
impl R {
    ...
    #[doc = "Bit 2 - Управление приёмником"]
    #[inline(always)]
    pub fn re(&self) -> ReR {
    ...
    #[doc = "Bit 5 - Управление прерыванием при успешном приёме данных или перезаписи полученных данных"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Управление прерыванием при ошибке в принятом бите чётности"]
    #[inline(always)]
    pub fn peie(&self) -> PeieR {
        PeieR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Выбор способа формирования бита чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn ps(&self) -> PsR {
        PsR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Контроль чётности. Примечание: Этот бит может быть изменён только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn pce(&self) -> PceR {
        PceR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bits 12:28 - M1\\[28\\] и M0\\[12\\] управляют длиной кадра. Примечание: Эти биты могут быть изменены только при остановке работы (UE=0)"]
    #[inline(always)]
    pub fn m(&self) -> MR {
