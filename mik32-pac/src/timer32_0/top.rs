...
#[doc = "Field `TIM_TOP` reader - максимальное значение счётчика (ограничивает счётную последоваельность сверху)"]
pub type TimTopR = crate::FieldReader<u32>;
#[doc = "Field `TIM_TOP` writer - максимальное значение счётчика (ограничивает счётную последоваельность сверху)"]
pub type TimTopW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - максимальное значение счётчика (ограничивает счётную последоваельность сверху)"]
    #[inline(always)]
