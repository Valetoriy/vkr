...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Head10r {
    #[doc = "0: Ведущий отправляет полную последовательность для чтения для 10 битного адреса: Start + 2 байта адреса (запись) + ReStart + заголовок 10-битного адреса (чтение)"]
    Complete = 0,
...
impl Head10rR {
    ...
    #[doc = "Ведущий отправляет полную последовательность для чтения для 10 битного адреса: Start + 2 байта адреса (запись) + ReStart + заголовок 10-битного адреса (чтение)"]
    #[inline(always)]
...
#[doc = "Формирование NACK в режиме «ведомый». Устанавливается программно, сбрасывается аппаратно: • после отправки NACK; • по событию STOP на шине; • при получении своего адреса ведомого; • PE=0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Nack {
...
#[doc = "Field `NACK` reader - Формирование NACK в режиме «ведомый». Устанавливается программно, сбрасывается аппаратно: • после отправки NACK; • по событию STOP на шине; • при получении своего адреса ведомого; • PE=0"]
...
#[doc = "Field `NACK` writer - Формирование NACK в режиме «ведомый». Устанавливается программно, сбрасывается аппаратно: • после отправки NACK; • по событию STOP на шине; • при получении своего адреса ведомого; • PE=0"]
...
#[doc = "Field `NBYTES` reader - Количество байт для приёма / передачи Не имеет значения в режиме «ведомый» при SBC=0. Не допускается изменение при установленном бите START"]
pub type NbytesR = crate::FieldReader;
#[doc = "Field `NBYTES` writer - Количество байт для приёма / передачи Не имеет значения в режиме «ведомый» при SBC=0. Не допускается изменение при установленном бите START"]
...
#[doc = "Управление режимом автоматического окончания в режиме «ведущий». Бит устанавливается и очищается программой. Не имеет значения при установленном бите RELOAD и в режиме «ведомый»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Autoend {
    #[doc = "0: Режим автоматического окончания отключён"]
    Disable = 0,
    #[doc = "1: Режим автоматического окончания включён"]
    Enable = 1,
}
...
#[doc = "Field `AUTOEND` reader - Управление режимом автоматического окончания в режиме «ведущий». Бит устанавливается и очищается программой. Не имеет значения при установленном бите RELOAD и в режиме «ведомый»"]
...
impl AutoendR {
    ...
    #[doc = "Режим автоматического окончания отключён"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == Autoend::Disable
    }
    #[doc = "Режим автоматического окончания включён"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == Autoend::Enable
    }
}
#[doc = "Field `AUTOEND` writer - Управление режимом автоматического окончания в режиме «ведущий». Бит устанавливается и очищается программой. Не имеет значения при установленном бите RELOAD и в режиме «ведомый»"]
...
impl R {
    ...
    #[doc = "Bit 15 - Формирование NACK в режиме «ведомый». Устанавливается программно, сбрасывается аппаратно: • после отправки NACK; • по событию STOP на шине; • при получении своего адреса ведомого; • PE=0"]
    #[inline(always)]
    pub fn nack(&self) -> NackR {
        NackR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bits 16:23 - Количество байт для приёма / передачи Не имеет значения в режиме «ведомый» при SBC=0. Не допускается изменение при установленном бите START"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - Управление режимом автоматического окончания в режиме «ведущий». Бит устанавливается и очищается программой. Не имеет значения при установленном бите RELOAD и в режиме «ведомый»"]
    #[inline(always)]
