...
#[doc = "Field `SAH_TIME` reader - Время выборки очередного отсчёта в тактах АЦП"]
pub type SahTimeR = crate::FieldReader;
#[doc = "Field `SAH_TIME` writer - Время выборки очередного отсчёта в тактах АЦП"]
...
impl R {
    ...
    #[doc = "Bits 8:13 - Время выборки очередного отсчёта в тактах АЦП"]
    #[inline(always)]
