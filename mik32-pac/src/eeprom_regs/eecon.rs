...
#[doc = "Field `EX` writer - Запуск процедуры. Запись «1» в данный бит инициирует выполнение процедуры, процедура определяется битами OP"]
...
pub enum Wrben {
    ...
    OnePage = 0,
    #[doc = "1: стирание/програмирование всех чётных страниц;"]
    EvenPages = 1,
    #[doc = "2: стирание/програмирование всех нечётных страниц;"]
    OddPages = 2,
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "стирание/програмирование всех чётных страниц;"]
    #[inline(always)]
    pub fn even_pages(self) -> &'a mut crate::W<REG> {
        self.variant(Wrben::EvenPages)
    }
    #[doc = "стирание/програмирование всех нечётных страниц;"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Запуск процедуры. Запись «1» в данный бит инициирует выполнение процедуры, процедура определяется битами OP"]
    #[inline(always)]
