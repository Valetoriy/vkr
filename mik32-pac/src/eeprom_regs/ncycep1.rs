...
#[doc = "Field `N_EP_1` reader - Длительность высокого уровня сигнала BUSY (вход Hard IP) в тактах. Рекомендуемое значение N RA = 2000000 нс / Pclk, где Pclk – период тактового сигнала в нс. Пример – 66667 тактов для частоты Fclk = 33,3 МГц. Запрещено устанавливать равным 0"]
pub type NEp1R = crate::FieldReader<u32>;
#[doc = "Field `N_EP_1` writer - Длительность высокого уровня сигнала BUSY (вход Hard IP) в тактах. Рекомендуемое значение N RA = 2000000 нс / Pclk, где Pclk – период тактового сигнала в нс. Пример – 66667 тактов для частоты Fclk = 33,3 МГц. Запрещено устанавливать равным 0"]
pub type NEp1W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
impl R {
    #[doc = "Bits 0:17 - Длительность высокого уровня сигнала BUSY (вход Hard IP) в тактах. Рекомендуемое значение N RA = 2000000 нс / Pclk, где Pclk – период тактового сигнала в нс. Пример – 66667 тактов для частоты Fclk = 33,3 МГц. Запрещено устанавливать равным 0"]
    #[inline(always)]
