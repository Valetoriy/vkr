...
impl RegisterBlock {
    #[doc = "0x00 - Задаёт значение делителя шины AHB. Частота шины AHB (AHB_CLK) рассчитывается, как SYS_CLK/(DIV_AHB+1)"]
    #[inline(always)]
    pub const fn div_ahb(&self) -> &DivAhb {
        &self.div_ahb
    }
    #[doc = "0x04 - Задаёт значение делителя частоты шины APB_M. Частота шины APB_M (APB_M_CLK) рассчитывается, как AHB_CLK/(DIV_APB_M+1)"]
    #[inline(always)]
    pub const fn div_apb_m(&self) -> &DivApbM {
        &self.div_apb_m
    }
    #[doc = "0x08 - Задаёт значение делителя частоты шины APB_P. Частота шины APB_P (APB_M_CLK) рассчитывается, как AHB_CLK/(DIV_APB_P+1)"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn sys_clk_mux(&self) -> &SysClkMux {
        &self.sys_clk_mux
    }
    ...
    #[doc = "0x3c - Переход в спящий режим осуществляется записью «1» в три младшие бита данного регистра. При записи отключается тактирование ядра. В зависимости от записываемого значения отключается тактирование модулей"]
    #[inline(always)]
    pub const fn sleep_mode(&self) -> &SleepMode {
        &self.sleep_mode
    }
}
#[doc = "DIV_AHB (rw) register accessor: Задаёт значение делителя шины AHB. Частота шины AHB (AHB_CLK) рассчитывается, как SYS_CLK/(DIV_AHB+1)\n\nYou can [`read`](crate::Reg::read) this register and get [`div_ahb::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`div_ahb::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@div_ahb`] module"]
#[doc(alias = "DIV_AHB")]
...
#[doc = "SYS_CLK_MUX (rw) register accessor: Настройка источника тактирования системы\n\nYou can [`read`](crate::Reg::read) this register and get [`sys_clk_mux::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sys_clk_mux::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sys_clk_mux`] module"]
#[doc(alias = "SYS_CLK_MUX")]
pub type SysClkMux = crate::Reg<sys_clk_mux::SysClkMuxSpec>;
#[doc = "Настройка источника тактирования системы"]
pub mod sys_clk_mux;
#[doc = "WDT_CLK_MUX (rw) register accessor: Выбор источника тактирования сторожевого таймера: 0 – внешний OSC32M; 1 – внутренний HSI32M; 2 – внешний OSC32K; 3 – внутренний LSI32К;\n\nYou can [`read`](crate::Reg::read) this register and get [`wdt_clk_mux::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wdt_clk_mux::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@wdt_clk_mux`] module"]
