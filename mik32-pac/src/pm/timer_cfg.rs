...
pub enum MuxTim32_0Tim1 {
    ...
    SysClk = 0,
    #[doc = "1: Частота шины AHB (AHB_CLK)"]
    AhbClk = 1,
}
...
impl MuxTim32_0Tim1R {
    ...
    #[doc = "Частота шины AHB (AHB_CLK)"]
    #[inline(always)]
    pub fn is_ahb_clk(&self) -> bool {
        *self == MuxTim32_0Tim1::AhbClk
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "Частота шины AHB (AHB_CLK)"]
    #[inline(always)]
    pub fn ahb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(MuxTim32_0Tim1::AhbClk)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn ahb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(MuxTim32_1Tim1::AhbClk)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn ahb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(MuxTim32_2Tim1::AhbClk)
    }
}
...
pub enum MuxTim16_0 {
    ...
    Osc32m = 2,
    #[doc = "3: Частота внутреннего осциллятора HSI32M"]
    Hsi32m = 3,
    #[doc = "4: частота внешнего осциллятора OSC32К"]
    Osc32k = 4,
    #[doc = "5: Частота внутреннего осциллятора LSI32K"]
    Lsi32k = 5,
}
...
impl MuxTim16_0R {
    ...
    #[doc = "Частота внутреннего осциллятора HSI32M"]
    #[inline(always)]
    ...
    #[doc = "Частота внутреннего осциллятора LSI32K"]
    #[inline(always)]
    pub fn is_lsi32k(&self) -> bool {
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn ahb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(MuxTim16_0::AhbClk)
    }
    #[doc = "Частота внешнего осциллятора OSC32М"]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn ahb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(MuxTim16_1::AhbClk)
    }
    #[doc = "Частота внешнего осциллятора OSC32М"]
    #[inline(always)]
    pub fn osc32m(self) -> &'a mut crate::W<REG> {
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn ahb_clk(self) -> &'a mut crate::W<REG> {
        self.variant(MuxTim16_2::AhbClk)
    }
    #[doc = "Частота внешнего осциллятора OSC32М"]
    #[inline(always)]
    pub fn osc32m(self) -> &'a mut crate::W<REG> {
