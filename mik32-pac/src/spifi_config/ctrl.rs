...
#[doc = "Field `CSHIGH` reader - Количество периодов сигнала SPIFI_SCK минус один, в течение которых сигнал SPIFI_CS остаётся в неактивном состоянии перед началом выполнения команды"]
pub type CshighR = crate::FieldReader;
#[doc = "Field `CSHIGH` writer - Количество периодов сигнала SPIFI_SCK минус один, в течение которых сигнал SPIFI_CS остаётся в неактивном состоянии перед началом выполнения команды"]
...
#[doc = "Бит запрещения кеширования данных (транзакций AHB, для которых сигнал HPROT\\[0:0\\] = 1)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DCacheDis {
...
#[doc = "Field `D_CACHE_DIS` reader - Бит запрещения кеширования данных (транзакций AHB, для которых сигнал HPROT\\[0:0\\] = 1)"]
...
#[doc = "Field `D_CACHE_DIS` writer - Бит запрещения кеширования данных (транзакций AHB, для которых сигнал HPROT\\[0:0\\] = 1)"]
...
#[doc = "Field `SCK_DIV` reader - Делитель для получения тактового сигнала SPIFI_SCK из системного тактового сигнала AHB_CLK. Частота рассчитывается по формуле: SPIFI_SCK = AHB_CLK / 2^(SCK_DIV+1)"]
pub type SckDivR = crate::FieldReader;
#[doc = "Field `SCK_DIV` writer - Делитель для получения тактового сигнала SPIFI_SCK из системного тактового сигнала AHB_CLK. Частота рассчитывается по формуле: SPIFI_SCK = AHB_CLK / 2^(SCK_DIV+1)"]
...
#[doc = "Бит выбора протокола: сигналы IO\\[3:0\\] – (0–4) битовый протокол; сигналы IO\\[1:0\\] – (1–2) битовый протокол\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dual {
    #[doc = "0: Сигналы IO\\[3:0\\] – (0–4) битовый протокол"]
    SingleOrQuad = 0,
    #[doc = "1: Сигналы IO\\[1:0\\] – (1–2) битовый протокол"]
    Dual = 1,
}
...
#[doc = "Field `DUAL` reader - Бит выбора протокола: сигналы IO\\[3:0\\] – (0–4) битовый протокол; сигналы IO\\[1:0\\] – (1–2) битовый протокол"]
...
impl DualR {
    ...
    #[doc = "Сигналы IO\\[3:0\\] – (0–4) битовый протокол"]
    #[inline(always)]
    pub fn is_single_or_quad(&self) -> bool {
        *self == Dual::SingleOrQuad
    }
    #[doc = "Сигналы IO\\[1:0\\] – (1–2) битовый протокол"]
    #[inline(always)]
    pub fn is_dual(&self) -> bool {
        *self == Dual::Dual
    }
}
#[doc = "Field `DUAL` writer - Бит выбора протокола: сигналы IO\\[3:0\\] – (0–4) битовый протокол; сигналы IO\\[1:0\\] – (1–2) битовый протокол"]
...
impl R {
    ...
    #[doc = "Bits 16:19 - Количество периодов сигнала SPIFI_SCK минус один, в течение которых сигнал SPIFI_CS остаётся в неактивном состоянии перед началом выполнения команды"]
    #[inline(always)]
    ...
    #[doc = "Bit 21 - Бит запрещения кеширования данных (транзакций AHB, для которых сигнал HPROT\\[0:0\\] = 1)"]
    #[inline(always)]
    ...
    #[doc = "Bits 24:26 - Делитель для получения тактового сигнала SPIFI_SCK из системного тактового сигнала AHB_CLK. Частота рассчитывается по формуле: SPIFI_SCK = AHB_CLK / 2^(SCK_DIV+1)"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - Бит выбора протокола: сигналы IO\\[3:0\\] – (0–4) битовый протокол; сигналы IO\\[1:0\\] – (1–2) битовый протокол"]
    #[inline(always)]
