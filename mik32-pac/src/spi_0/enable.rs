...
#[doc = "Field `CLEAR_RX_FIFO` writer - Запись «1» при SPI_EN = 0 очищает буфер RX_FIFO"]
pub type ClearRxFifoW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    pub fn clear_rx_fifo(&mut self) -> ClearRxFifoW<EnableSpec> {
        ClearRxFifoW::new(self, 3)
    }
}
