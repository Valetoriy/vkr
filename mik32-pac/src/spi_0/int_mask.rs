...
#[doc = "(IXR_RXOVR) Текущее состояние маски прерывания при переполнении при приёме\n\nValue on reset: 0"]
...
#[doc = "Field `RX_OVERFLOW` reader - (IXR_RXOVR) Текущее состояние маски прерывания при переполнении при приёме"]
...
impl R {
    #[doc = "Bit 0 - (IXR_RXOVR) Текущее состояние маски прерывания при переполнении при приёме"]
    #[inline(always)]
