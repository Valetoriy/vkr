...
#[doc = "Управляет скоростью передачи данных, задаёт коэффициент деления частоты spi_ref_clk\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
#[doc = "Field `BAUD_RATE_DIV` reader - Управляет скоростью передачи данных, задаёт коэффициент деления частоты spi_ref_clk"]
...
#[doc = "Field `BAUD_RATE_DIV` writer - Управляет скоростью передачи данных, задаёт коэффициент деления частоты spi_ref_clk"]
...
pub enum Cs {
    ...
    NotSelected = 15,
    #[doc = "13: Выбрано устройство 1"]
    Cs1 = 13,
    #[doc = "11: Выбрано устройство 2"]
    Cs2 = 11,
    #[doc = "7: Выбрано устройство 3"]
    Cs3 = 7,
    #[doc = "14: Выбрано устройство 4"]
    Cs4 = 14,
}
impl From<Cs> for u8 {
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 3:5 - Управляет скоростью передачи данных, задаёт коэффициент деления частоты spi_ref_clk"]
    #[inline(always)]
