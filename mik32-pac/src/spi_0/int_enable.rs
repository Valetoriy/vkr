...
#[doc = "Field `RX_OVERFLOW` writer - (IXR_RXOVR) Запись «1» устанавливает маску прерывания (разрешает прерывание) при переполнении при приёме"]
...
impl W {
    #[doc = "Bit 0 - (IXR_RXOVR) Запись «1» устанавливает маску прерывания (разрешает прерывание) при переполнении при приёме"]
    #[inline(always)]
