...
impl RegisterBlock {
    ...
    #[doc = "0x04 - Регистр статуса. Примечание: биты регистра \\[6:0\\] устанавливаются в «1», если произошло событие вызывающее прерывание"]
    #[inline(always)]
    ...
    #[doc = "0x24 - Регистр счётчика останова ведомого устройства"]
    #[inline(always)]
    ...
    #[doc = "0xfc - Идентификационный номер модуля"]
    #[inline(always)]
...
pub mod config;
#[doc = "STATUS (r) register accessor: Регистр статуса. Примечание: биты регистра \\[6:0\\] устанавливаются в «1», если произошло событие вызывающее прерывание\n\nYou can [`read`](crate::Reg::read) this register and get [`status::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@status`] module"]
#[doc(alias = "STATUS")]
pub type Status = crate::Reg<status::StatusSpec>;
#[doc = "Регистр статуса. Примечание: биты регистра \\[6:0\\] устанавливаются в «1», если произошло событие вызывающее прерывание"]
pub mod status;
