...
pub enum Control {
    ...
    Vcc = 0,
    #[doc = "1: VBAT - источник напряжения VCC_BU"]
    Vbat = 1,
}
...
impl ControlR {
    ...
    #[doc = "VBAT - источник напряжения VCC_BU"]
    #[inline(always)]
    pub fn is_vbat(&self) -> bool {
        *self == Control::Vbat
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "VBAT - источник напряжения VCC_BU"]
    #[inline(always)]
    pub fn vbat(self) -> &'a mut crate::W<REG> {
        self.variant(Control::Vbat)
    }
}
