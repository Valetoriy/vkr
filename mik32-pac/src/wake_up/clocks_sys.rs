...
impl Force32kClkR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Force32kClk> {
        match self.bits {
            0 => Some(Force32kClk::Automatic),
            1 => Some(Force32kClk::Lsi32k),
            2 => Some(Force32kClk::Osc32k),
            _ => None,
        }
    }
...
pub type Force32kClkW<'a, REG> = crate::FieldWriter<'a, REG, 2, Force32kClk>;
