...
pub enum Oa2msk {
    ...
    _6_1Masked = 6,
    #[doc = "7: OA2\\[7:1\\] маскируются, подтверждаются (ACK) все 7-битные адреса (кроме зарезервированных)"]
    _7_1Masked = 7,
}
...
impl Oa2mskR {
    ...
    #[doc = "OA2\\[7:1\\] маскируются, подтверждаются (ACK) все 7-битные адреса (кроме зарезервированных)"]
    #[inline(always)]
...
#[doc = "Использование собственного адреса OA2\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Oa2en {
...
#[doc = "Field `OA2EN` reader - Использование собственного адреса OA2"]
...
#[doc = "Field `OA2EN` writer - Использование собственного адреса OA2"]
...
impl R {
    ...
    #[doc = "Bit 15 - Использование собственного адреса OA2"]
    #[inline(always)]
