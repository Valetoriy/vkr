...
#[doc = "Разрешение прерывания при приёме\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rxie {
    #[doc = "0: Прерывание запрещено"]
    Disable = 0,
...
#[doc = "Field `RXIE` reader - Разрешение прерывания при приёме"]
...
#[doc = "Field `RXIE` writer - Разрешение прерывания при приёме"]
...
#[doc = "Разрешение прерывания соответствия адреса в режиме «ведомый»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Addrie {
    #[doc = "0: Прерывание запрещено"]
    Disable = 0,
...
#[doc = "Field `ADDRIE` reader - Разрешение прерывания соответствия адреса в режиме «ведомый»"]
...
#[doc = "Field `ADDRIE` writer - Разрешение прерывания соответствия адреса в режиме «ведомый»"]
...
#[doc = "Разрешение прерывания приём NACK\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Nackie {
    #[doc = "0: Прерывание запрещено"]
    Disable = 0,
...
#[doc = "Field `NACKIE` reader - Разрешение прерывания приём NACK"]
...
#[doc = "Field `NACKIE` writer - Разрешение прерывания приём NACK"]
...
#[doc = "Разрешение прерывания при ошибке. События, вызывающие прерывание: - потеря арбитража (ARLO); - ошибка шины (BERR); - переполнение/недозагрузка (OVR)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Errie {
    #[doc = "0: Прерывание запрещено"]
    Disable = 0,
...
#[doc = "Field `ERRIE` reader - Разрешение прерывания при ошибке. События, вызывающие прерывание: - потеря арбитража (ARLO); - ошибка шины (BERR); - переполнение/недозагрузка (OVR)"]
...
#[doc = "Field `ERRIE` writer - Разрешение прерывания при ошибке. События, вызывающие прерывание: - потеря арбитража (ARLO); - ошибка шины (BERR); - переполнение/недозагрузка (OVR)"]
...
#[doc = "Режим поддержки DMA при приёме данных\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rxdmaen {
    #[doc = "0: Поддержка DMA выключена"]
    Disable = 0,
...
#[doc = "Field `RXDMAEN` reader - Режим поддержки DMA при приёме данных"]
...
#[doc = "Field `RXDMAEN` writer - Режим поддержки DMA при приёме данных"]
...
#[doc = "Отключение растягивания тактового сигнала в режиме «ведомый». Изменение значения допускается только при выключенном блоке (PE=0). В режиме «ведущий» бит должен быть установлен в «0»\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Nostretch {
...
#[doc = "Field `NOSTRETCH` reader - Отключение растягивания тактового сигнала в режиме «ведомый». Изменение значения допускается только при выключенном блоке (PE=0). В режиме «ведущий» бит должен быть установлен в «0»"]
...
#[doc = "Field `NOSTRETCH` writer - Отключение растягивания тактового сигнала в режиме «ведомый». Изменение значения допускается только при выключенном блоке (PE=0). В режиме «ведущий» бит должен быть установлен в «0»"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Gcen {
    #[doc = "0: Адрес 0b00000000 запрещён, формируется NACK"]
    Disabled = 0,
...
impl GcenR {
    ...
    #[doc = "Адрес 0b00000000 запрещён, формируется NACK"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 2 - Разрешение прерывания при приёме"]
    #[inline(always)]
    pub fn rxie(&self) -> RxieR {
        RxieR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Разрешение прерывания соответствия адреса в режиме «ведомый»"]
    #[inline(always)]
    pub fn addrie(&self) -> AddrieR {
        AddrieR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Разрешение прерывания приём NACK"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Разрешение прерывания при ошибке. События, вызывающие прерывание: - потеря арбитража (ARLO); - ошибка шины (BERR); - переполнение/недозагрузка (OVR)"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - Режим поддержки DMA при приёме данных"]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - Отключение растягивания тактового сигнала в режиме «ведомый». Изменение значения допускается только при выключенном блоке (PE=0). В режиме «ведущий» бит должен быть установлен в «0»"]
    #[inline(always)]
