...
#[doc = "Использование собственного адреса OA1\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Oa1en {
...
#[doc = "Field `OA1EN` reader - Использование собственного адреса OA1"]
...
#[doc = "Field `OA1EN` writer - Использование собственного адреса OA1"]
...
impl R {
    ...
    #[doc = "Bit 15 - Использование собственного адреса OA1"]
    #[inline(always)]
